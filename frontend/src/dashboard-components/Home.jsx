    ...
    const QuestionsResponse =  [
        {
            ...
            answer: "The purpose of this application is to provide a platform for the employees to view their details and update them if necessary."
        },
        {
            question: "What are the features of this application?",
            answer: "The application provides the following features: \n 1. View the list of all employees \n 2. View the details of an employee \n 3. Update the details of an employee"
        },
        {
            question: "How can I view the list of all employees?",
            answer: "You can view the list of all employees by clicking on the 'Employees' tab in the navigation bar."
        },
        {
            question: "How can I view the details of an employee?",
            answer: "You can view the details of an employee by clicking on the 'View' button next to the employee's name in the list of employees."
        },
        {
            question: "How can I update the details of an employee?",
            answer: "You can update the details of an employee by clicking on the 'Update' button next to the employee's name in the list of employees."
        },
        {
            question: "How can I update the details of an employee?",
            answer: "You can update the details of an employee by clicking on the 'Update' button next to the employee's name in the list of employees."
...
question: "How can I update the details of an employee?",
    ...
    <div className="h-full w-full fixed overflow-y-auto">
        <div className="mt-16 h-full flex flex-col gap-24 px-5 lg:px-16">
            ...
            <div className="w-full flex flex-col gap-5 text-xl">
                <h1 className="documentation-right-title underline">Introduction :</h1>
                <p>{introduction}</p>
            </div>
  ...
  return (
    <li key={index} className="w-full rounded-box shadow shadow-first" onClick={() => setSelectedQuestion(selectedQuestion === index ? null : index)}>
        <div className="h-24 sm:h-16 flex flex-col sm:flex-row items-center sm:justify-between px-10 btn btn-ghost bg-second hover:bg-fourth">
            <h3 >{questionResponse.question}</h3>
        ...
        {selectedQuestion === index && <p className={"p-5"}>{questionResponse.answer}</p>}
    </li>
  )
                 })}
                </ul>
