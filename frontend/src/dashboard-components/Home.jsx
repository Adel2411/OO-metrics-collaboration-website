...
function Home({ setPage }) {
  ...
  const QuestionsResponse = [
    ...
    {
      question:
        "Où puis-je trouver les définitions des différentes métriques ?",
      answer:
    ...
    {
      question:
        "Comment puis-je tester les métriques sur mon propre projet Java ?",
      answer:
    ...
    {
      question:
        "Puis-je utiliser les métriques pour tout type de projet logiciel ?",
      answer:
          ...
          <ul className="flex flex-col items-center gap-5 mb-24">
            {QuestionsResponse.map((questionResponse, index) => {
              return (
                ...
                >
                  <button className="w-full h-24 sm:h-16 flex flex-col sm:flex-row items-center sm:justify-between px-10 rounded-t-xl bg-second">
                  ...
                  {selectedQuestion === index && (
                    <p
                      className={
                        "p-5 text-md lg:text-lg rounded-b-xl bg-fourth shadow shadow-first"
                      }
                    >
