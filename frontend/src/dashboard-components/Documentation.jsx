...
function Documentation() {
  ...
  return (
      <div className="z-0">
        <div>
          <div
              className="overflow-y-auto w-1/5 hidden md:flex bg-fourth gap-10 py-10 flex-col items-center h-screen fixed">
        ...
        <button onClick={() => setShowImplementation(!showImplementation)} className="fixed right-4 bottom-4 bg-blue-500 text-white p-2 rounded-full">Fixed Button</button>
        <input type="checkbox" onChange={() => setShowImplementation(!showImplementation)} className="fixed left-4 bottom-4 toggle [--tglbg:yellow] bg-blue-500 hover:bg-blue-700 border-blue-500"
               checked/>
      </div>
  );
}
